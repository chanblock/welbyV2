...
function App() {
 ...
 // Componente auxiliar para manejar la lógica del Footer
 const Layout = () => {
  const location = useLocation();

  // Determina si debemos mostrar el Footer
      ...
      <Router >
        ...
        <ReportProvider>
            <Routes>
              ...
              <Route path="/dashboard"element={<RequireAuth isAuthenticated={isAuthenticated}>
                    <Dashboard />
                  </RequireAuth>
                }
              />
