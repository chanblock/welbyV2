  ...
  const handleLogin = async (email, password) => {
    ...
    try {
      ...
      if(data.subscription){
        ...
        localStorage.setItem("statusSubscription", data.status_subscription)
      }
      ...
      if (data.subscription === true){
        if (data.subscription_end_date) {
          ...
          // let statusSubscription = localStorage.getItem("statusSubscription");
          // if (statusSubscription && statusSubscription === "canceled") {
          //   localStorage.setItem("fullAccess", false);
          // }
