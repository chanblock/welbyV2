...
import { registerUser, loginUser,getListChildCare,UpdateFieldUser} from '../../api/user';
import { paymentSubscription,updateHadSuccessfulSubscription } from '../../api/payment';
    ...
    if (step === 1) {
      ...
      if (isRegistered){
        ...
        try {
          ...
          setLoading(true);
            const createSubcription = await paymentSubscription(dataToken, email,name,subscription_type );
          ...
          if (createSubcription.subscription.clientSecret) {
              ...
              if (error) {
                ...
                if (paymentIntent && paymentIntent.status === 'succeeded') {
                    await UpdateFieldUser(dataToken,"subscription_type",subscription_type);
                    await updateHadSuccessfulSubscription(dataToken, true);
                    setLoading(false);
                ...
                {step === 2 && (
                  <div className="step-container">
                    <div className="form-section">
                            ...
                            <p>All your transactions are secure and encrypted through the stripe platform</p>
