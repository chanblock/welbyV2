...
import ObservationsModal from "./report/reportModal/ObservationsModal";
import {checkAndClearStorage} from "../utils"
    ...
    return (
        <div className="home-container">
            ...
            <Modal show={showObservations} onHide={handleCloseObservations}>
                ...
                <Modal.Body>    
                <ObservationsModal childs={childs}></ObservationsModal>
                </Modal.Body>
            </Modal>
            ...
            <div className="cardModern">
                ...
                <div className="item item--2">
                    ...
                    <div className="footer-card">
                        ...
                        <button className={`buttonCard ${!fullAccess ? "link-disabled" : ""}`} onClick={() => handleShowTutorial("https://www.youtube.com/embed/zad3bDnjsII?si=xz8vXrZzwduvxFlR")} variant="info" disabled><span>Tutorial </span></button>
