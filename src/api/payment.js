...
export const checkSubscription = async (token) => {
    try {
        ...
        console.error('Error in checkSubscription ');
        throw error;
    }
}
...
export const paymentSubscription = async (token, email, name,subscription_type) => {
    try {
        const response = await fetch(`${BASE_URL}/users/payment-subscription/`, {
            ...
            body: JSON.stringify({ email, name, token,subscription_type }),
        });
        const data = await response.json();

        return data;
    } catch (error) {
        console.error('Error in paymentSubscription');
        throw error;
    }
}
...
export const updateCard = async (token, paymentMethodId, subscriptionId) => {
    try {
        ...
        console.error('Error in updateCard');
        throw error;
    }
...
export const sendDiscountEmail = async (token) => {
    try {
        ...
        console.error('Error sendDiscountEmail');
        throw error;
    }
}